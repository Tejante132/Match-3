...
class Pimped_Entry(TK.Entry):
    ...
    def __init__(self, master, **param):
        ...
        self.__image = TK.PhotoImage(file = "fleche.png")
    ...
    def update_shape(self):
        _convention_couleurs = {"": "white", "Puits":"green", "Source":"red"}
            ...
            for _key, _element in self._grille.items():
                if _element.get() == "":
                    ...
                    if "TP" in _options:
                        ...
                        coordonnees = _options["TP"][1:-1].split(",")
                        if coordonnees[0] <= self.dimensions[0] and coordonnees[1] <= self.dimensions[1]:
                            _cellule.attrib["flux_tp_vers"] = _options["TP"]
                        else:
