...
for case_xml in tronc[0]:
    la_position = [la_map.ses_dimensions[0] -1 - int(case_xml.get("ligne")), int(case_xml.get('colonne'))]
...
class Interface():
    def __init__(self,ma_map):        
        ...
        decalage = la_map.ses_dimensions[0]
        
        TK.Label(self.fenetre, text="Elements détruits:").grid(row=2+decalage, column=0, columnspan=3, sticky = 'w e n s', padx = 5, pady = 5)
        TK.Label(self.fenetre, text="objectifs d'éléments").grid(row=2+decalage, column=3, columnspan=3, sticky = 'w e n s', padx = 5, pady = 5)
        
        TK.Label(self.fenetre, text="Boni activés:").grid(row=3+decalage, column=0, columnspan=3, sticky = 'w e n s', padx = 5, pady = 5)
        TK.Label(self.fenetre, text="Boni activés").grid(row=3+decalage, column=3, columnspan=3, sticky = 'w e n s', padx = 5, pady = 5)
        
        #TK.Label(self.fenetre, text=("Etoiles dans un puits:").grid(row4+decalage, column=0, columnspan=3, sticky = 'w e n s', padx = 5, pady = 5)
...
case1 = grille.retourner_case([2,0])
case2 = grille.retourner_case([1,2])