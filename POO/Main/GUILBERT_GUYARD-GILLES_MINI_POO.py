...
#chemin d'accès du niveau testé (format .xml)
...
class Grille():
    ...
    def exploser_bonus(self, localisation):
        ...
        if isinstance(bonus,Bonus):
            compteur["Bonus"]+=1        #on va activer le bonus
...
class Interface():
    def __init__(self,ma_map):        
        ...
        TK.Button(self.fenetre, text="RESET", command=chargement_XML).grid(row=l, column=6, rowspan=1, columnspan = ma_map.ses_dimensions[1]+1-6, sticky = 'w e n s', padx = 5, pady = 5)
        l+=1    #ligne
        ...
        def remplissage_grille():
            for case in ma_map.sa_grille.ses_cases:
                ...
                label = TK.Button(self.fenetre, text=icone_element(case), command=lambda : 1,
                         bg=couleur_case(case),fg=couleur_element(case),pady=10, padx=10, font=25)
        ...
        #màj de l'affichage (rechargela grille)
        TK.Button(self.fenetre, text="REFRESH", command=remplissage_grille).grid(row=l-ma_map.ses_dimensions[0]-1, column=6, rowspan=1, columnspan = ma_map.ses_dimensions[1]+1-6, sticky = 'w e n s', padx = 5, pady = 5)
        ...
        i1 = TK.StringVar()
        j1 = TK.StringVar()
        TK.Label(self.fenetre, text="Test swap entre : [") .grid(row=l, column=0, columnspan=2, sticky = 'e n s', padx = 5, pady = 5)
        TK.Entry(self.fenetre, textvariable = i1).grid(row=l, column=2, columnspan = 1, sticky = 'w e n s', padx = 5, pady = 5)   
        TK.Label(self.fenetre, text=" , ").grid(row=l, column=3, columnspan=1, sticky = 'w e n s', padx = 5, pady = 5)
        TK.Entry(self.fenetre, textvariable = j1).grid(row=l, column=4, columnspan = 1, sticky = 'w e n s', padx = 5, pady = 5)   
        TK.Label(self.fenetre, text="]").grid(row=l, column=5, columnspan=1, sticky = 'w e n s', padx = 5, pady = 5)
        
        l+=1
        
        i2 = TK.StringVar()
        j2 = TK.StringVar()
        TK.Label(self.fenetre, text="et : [") .grid(row=l, column=0, columnspan=2, sticky = 'e n s', padx = 5, pady = 5)
        TK.Entry(self.fenetre, textvariable = i2).grid(row=l, column=2, columnspan = 1, sticky = 'n s', padx = 5, pady = 5)   
        TK.Label(self.fenetre, text=" , ").grid(row=l, column=3, columnspan=1, sticky = 'w e n s', padx = 5, pady = 5)
        TK.Entry(self.fenetre, textvariable = j2).grid(row=l, column=4, columnspan = 1, sticky = 'w e n s', padx = 5, pady = 5)   
        TK.Label(self.fenetre, text="]").grid(row=l, column=5, columnspan=1, sticky = 'w e n s', padx = 5, pady = 5)
       
        TK.Button(self.fenetre,text="Valider swap", command=lambda : switch([int(i1.get()),int(j1.get())],[int(i2.get()),int(j2.get())])).grid(row=l-1, column=6, columnspan=ma_map.ses_dimensions[1]-1, rowspan=2, sticky = 'w e n s', padx = 5, pady = 5) 
        l+=1
        ...
        #     """
        #     pour inverser les cases de coord pos1 ([i1,j1]) et pose2 ([i2,j2]) dans l'interface
        #     """
        #     if abs(pos1[0]-pos2[0])==1 or abs(pos1[1]-pos2[1])==1:
        #         la_map.sa_grille.retourner_case(pos1).echanger_elements(la_map.sa_grille.retourner_case(pos2))
        #         remplissage_grille()
        #         sleep(1)
        #         la_map.sa_grille.test_swap(la_map.sa_grille.retourner_case(pos1),la_map.sa_grille.retourner_case(pos2))
        #         remplissage_grille()
        #         sleep(1)
        #         la_map.sa_grille.renouveler_grille()
        #         remplissage_grille()
        ...
        def switch(pos1, pos2):
            ...
            compteur["coups"] += 1
            for objectif in la_map.ses_objectifs:
                objectif.maj_quantite_restante()
        ...
        TK.Label(self.fenetre, text="Clic bonus sur: [") .grid(row=l, column=0, columnspan=2, sticky = 'e n s', padx = 5, pady = 5)
        TK.Entry(self.fenetre, textvariable = i3).grid(row=l, column=2, columnspan = 1, sticky = 'w e n s', padx = 5, pady = 5)   
        TK.Label(self.fenetre, text=" , ").grid(row=l, column=3, columnspan=1, sticky = 'w e n s', padx = 5, pady = 5)
        TK.Entry(self.fenetre, textvariable = j3).grid(row=l, column=4, columnspan = 1, sticky = 'w e n s', padx = 5, pady = 5)   
        TK.Label(self.fenetre, text="]").grid(row=l, column=5, columnspan=1, sticky = 'w e n s', padx = 5, pady = 5)
       
        #mettre fonctions test bonus...
        TK.Button(self.fenetre,text="Test clic", command=lambda : 1).grid(row=l, column=6, columnspan = 2, sticky = 'w e n s', padx = 5, pady = 5) 
        l+=1
